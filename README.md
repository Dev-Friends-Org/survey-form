...
https://practice-dev-tutorials.github.io/fcc-survey-form/

---

## Description

This is project 2 of 5 of freeCodeCamp's *Responsive Web Design Certificate* curriculum. The finished project is meant to be submitted via a link on CodePen.
The app should be functionally similar to this: https://codepen.io/freeCodeCamp/full/VPaoNP.
